...
export class GeminiClient {
    ...
    async getEnvironment() {
        ...
        const context = this.getProviderSpecificContext(authType, today, platform, cwd, folderStructure);
    ...
    async startChat(extraHistory) {
        ...
        try {
            ...
            const systemInstruction = getCoreSystemPrompt(userMemory, authType, model);
    ...
    getProviderSpecificContext(authType, today, platform, cwd, folderStructure) {
        switch (authType) {
            case AuthType.USE_ANTHROPIC:
                return `
  This is an AI CLI tool. We are setting up the context for our chat.
